...
// Ajuste a lógica do jogo de acordo com o nível atual durante a atualização do jogo
function update(idt) {
  if (playing) {
...
var difficultyLevels = {
  easy: {
    speed: 0.6,
    scoreThreshold: 1000, // Pontuação necessária para avançar de nível
  },
  medium: {
    speed: 0.5,
    scoreThreshold: 2000,
...
var currentLevel = "easy"; // Nível padrão
...
function startGame() {
  if (currentLevel !== null && !gameStarted) {
    // Configurar o jogo com o nível de dificuldade selecionado
    // Iniciar o jogo aqui
    run();
